...
public class Control {
	...
	public void turnOn () {tv.estado=true;}
	public void turnOff () {tv.estado=false;}
	public void volumenUp () {tv.volumenUp();}
	public void volumenDown () {tv.volumenDown();}
	public TV getTV () {return tv;}
	public void setTV (TV tl) {tv=tl;}
	public TV getTv () {return this.tv;}
	public void setTv (TV tele) {this.tv = tele;}
	public void enlazar (TV tele) {tv=tele;tv.control=this;}
}
